...
#if !DEBUG
#define NOMEMCHECK    // Get rid of memcheck from code
#endif
...
#else
    #define KEYSC_EXT_KEN_ADD 0
    //#define KEYSC_EXT_KEN_ADD 128
    #define KEYSC_RALT      (KEYSC_ALT+KEYSC_EXT_KEN_ADD)
    #define KEYSC_RCTRL     (KEYSC_CTRL+KEYSC_EXT_KEN_ADD)
    #define KEYSC_KPSLASH   (KEYSC_SLASH+KEYSC_EXT_KEN_ADD)
    #define KEYSC_KPENTER   (KEYSC_ENTER+KEYSC_EXT_KEN_ADD)
    #define KEYSC_PRINTSCREEN sc_PrintScreen
    #define KEYSC_LASTSC      sc_LastScanCode
    
    #define KEYSC_KP_1       (KEYSC_1+KEYSC_EXT_KEN_ADD)      
    #define KEYSC_KP_2       (KEYSC_2+KEYSC_EXT_KEN_ADD)      
    #define KEYSC_KP_3       (KEYSC_3+KEYSC_EXT_KEN_ADD)      
    #define KEYSC_KP_4       (KEYSC_4+KEYSC_EXT_KEN_ADD)      
    #define KEYSC_KP_5       (KEYSC_5+KEYSC_EXT_KEN_ADD)      
    #define KEYSC_KP_6       (KEYSC_6+KEYSC_EXT_KEN_ADD)      
    #define KEYSC_KP_7       (KEYSC_7+KEYSC_EXT_KEN_ADD)      
    #define KEYSC_KP_8       (KEYSC_8+KEYSC_EXT_KEN_ADD)      
    #define KEYSC_KP_9       (KEYSC_9+KEYSC_EXT_KEN_ADD)      
    #define KEYSC_KP_0       (KEYSC_0+KEYSC_EXT_KEN_ADD)      
    #define KEYSC_KPMINUS   (KEYSC_GMINUS+KEYSC_EXT_KEN_ADD)  
    #define KEYSC_KPPLUS    (KEYSC_GPLUS+KEYSC_EXT_KEN_ADD)   
    #define KEYSC_KPPERIOD  (KEYSC_PERIOD+KEYSC_EXT_KEN_ADD) 
    
    #define KEYSC_EUP        (KEYSC_UP+KEYSC_EXT_KEN_ADD)   
    #define KEYSC_EDOWN      (KEYSC_DOWN+KEYSC_EXT_KEN_ADD) 
    #define KEYSC_ELEFT      (KEYSC_LEFT+KEYSC_EXT_KEN_ADD) 
    #define KEYSC_ERIGHT     (KEYSC_RIGHT+KEYSC_EXT_KEN_ADD)
    #define KEYSC_EINS       (KEYSC_INS+KEYSC_EXT_KEN_ADD)  
    #define KEYSC_EDEL       (KEYSC_DEL+KEYSC_EXT_KEN_ADD)  
    #define KEYSC_EHOME      (KEYSC_HOME+KEYSC_EXT_KEN_ADD) 
    #define KEYSC_EEND       (KEYSC_END+KEYSC_EXT_KEN_ADD)  
    #define KEYSC_EPGUP      (KEYSC_PGUP+KEYSC_EXT_KEN_ADD) 
    #define KEYSC_EPGDN      (KEYSC_PGDN+KEYSC_EXT_KEN_ADD) 
