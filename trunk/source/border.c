...
short BorderTest[] =
    ...
    2579, 2580, 2581, 2582, 2583, 2584, 2585, 2593, 2594, 2604, 2606
    };
#else    
short BorderTest[] =
    {
...
#undef BORDER_TILE
#define BORDER_TILE (BorderTest[gs.BorderTile])
...
#ifdef __3DFX_ACC__
    // Don't let them resize the screen and smaller than the status bar
    if (value > 2) return;
#endif
