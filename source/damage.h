...
DAMAGE_ENTRY(WPN_SHOTGUN,         InitWeaponShotgun,     4,     4,   0,  52,  1, -1 )
DAMAGE_ENTRY(WPN_UZI,             InitWeaponUzi,         5,     7,   0, 200,  1, -1 )
DAMAGE_ENTRY(WPN_MICRO,           InitWeaponMicro,      15,    30,   0,  50,  1, -1 )
DAMAGE_ENTRY(WPN_GRENADE,         InitWeaponGrenade,    15,    30,   0,  50,  1, -1 )
DAMAGE_ENTRY(WPN_MINE,            InitWeaponMine,        5,    10,   0,  20,  1, -1 )
DAMAGE_ENTRY(WPN_RAIL,            InitWeaponRail,       40,    60,   0,  20,  1, -1 )
DAMAGE_ENTRY(WPN_HOTHEAD,         InitWeaponHothead,    10,    25,   0,  80,  1, -1 )
DAMAGE_ENTRY(WPN_HEART,           InitWeaponHeart,      75,   100,   0,   5,  1, -1 )
...
DAMAGE_ENTRY(DMG_NUCLEAR_EXP,     NULL,                 0,   800,  30000, -1, -1, -1 )
