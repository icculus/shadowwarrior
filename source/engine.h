...
void makepalookup( long palnum, char *remapbuf, signed char red, signed char green, signed char blue, char dastat );
...
void setbrightness(char brightness, char *palette);
// CTW MODIFICATION END
